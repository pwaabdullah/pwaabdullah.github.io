...
<section class="bio-section short-bio">
  ...
  <p>
    Previously, he led LLM initiatives at <strong>Aisera</strong>, architecting agentic AI systems for IT and HR domains—fine-tuning <strong>LLaMA-3 models</strong>, enhancing retrieval-augmented generation (RAG) pipelines, and optimizing model deployment to save millions in infrastructure costs. Before that, he was a Machine Learning Engineer at <strong>Meta</strong>, contributing to Ads Ranking and GenAI-based ad creation, generating hundreds of millions in incremental revenue, and playing a pivotal role in fine-tuning Meta’s <strong>LLaMA</strong> models for personalized ad experiences.
  </p>
  <p>
...
<section class="bio-section long-bio">
  ...
  <p>
    In <strong>2024</strong>, Abdullah joined <strong>Aisera</strong> as a <strong>Senior Research Scientist</strong>, where he led the design and deployment of <strong>agentic AI systems</strong> for enterprise IT and HR automation. He architected a scalable, reusable onboarding agent, and spearheaded the migration from commercial APIs (e.g., GPT-4) to in-house <strong>fine-tuned LLaMA-3 models</strong>, saving the company <strong>CAPEX</strong> significantly. He also enhanced the <strong>RAG pipeline</strong>, improving real-time semantic search performance by <strong>93%</strong>.
  </p>
  <p>
